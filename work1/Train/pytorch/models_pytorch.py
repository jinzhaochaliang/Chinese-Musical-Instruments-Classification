...
class CNN8_Cent(nn.Module):
    def __init__(self, classes_num):
        
        super(CNN8_Cent, self).__init__()
...
class Vggish4(nn.Module):
    def __init__(self, classes_num):
        
        super(Vggish4, self).__init__()
...
class Vggish6(nn.Module):
    def __init__(self, classes_num):
        
        super(Vggish6, self).__init__()
